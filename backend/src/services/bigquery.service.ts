  ...
  async storeAnalysisResults(
    ...
    try {
      if (!this.isEnabled) {
        ...
        // Optionally, you can still "log" the data locally
        // console.log("Local log of analysis data:", analysisData);
        return false;
      }

      // ✅ FIX: Create the object with conditional spreads for optional properties
      const insertData: BigQueryInsert = {
        ...
        ...(analysisData.userId && { user_id: analysisData.userId }),
      };
